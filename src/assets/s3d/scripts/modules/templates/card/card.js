...
function Card(
  ...
  const $vrButton = (() => {
    const isMarked = flat['3d_tour'] || flat['3d_tour_v3'];
    if (!isMarked) return '';
    return `
      ...
      <div class="s3d-card__info-wrapper">
        <div class="s3d-card__info-label-wrapper">
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.section')}: ${flat.section}
          </div>
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.floor')}: ${flat.floor}
          </div>
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.number')}: ${flat.number}
          </div>
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.rooms')}: ${flat.rooms}
          </div>
        </div>
        <!-- <div class="s3d-card__buttons">
            ${ButtonWithoutIcon('js-s3d-card__link', '', i18n.t('Flat.goToFlat'), 'secondary')}
        </div> -->
        <div class="s3d-card__vr-fav-block">
          ${$vrButton}
