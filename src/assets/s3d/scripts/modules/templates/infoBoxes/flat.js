...
function Flat(i18n, data) {
  ...
  const $vrButton = (() => {
    const isMarked = data['3d_tour'] || data['3d_tour_v3'];
    if (!isMarked) return '';
    return `
      ...
      <div class="s3d-card__info-wrapper">
        <div class="s3d-card__info-label-wrapper">
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.section')}: ${data.section}
          </div>
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.floor')}: ${data.floor}
          </div>
          <div class="s3d-card__info-label">
            ${i18n.t('Flat.information.number')}: ${data.number}
          </div>
          <div class="s3d-card__info-label">
