    ...
    resources: {
      uk: {
        translation: {
          ...
          subtitle:
            'Зв’яжіться з нашою командою, щоб вивчити плани поверхів, варіанти оздоблення та персоналізовані рішення відповідно до ваших побажань.',
          'Your name': "Ваше ім'я",
          'Your phone': 'Ваш телефон',
          'Your email': 'Ваш email',
          'Your comment': 'Ваш коментар',
          'Type your name': "Введіть ваше ім'я",
          'Type your phone': 'Введіть ваш телефон',
          'Type your email': 'Введіть ваш email',
          'Type your comment': 'Введіть ваш коментар',
          ...
          only_number: 'Тут можуть бути лише цифри',
          required: "Це поле обов'язкове для заповнення",
          sendingSuccessTitle: 'Дякуємо за ваш запит!',
          sendingSuccessText: 'Очікуйте на відповідь нашого менеджера',
          sendingErrorText: 'Очікуйте на відповідь нашого менеджера',
          ...
          invalid_recaptcha:
            'Будь ласка, пройдіть капчу та спробуйте ще раз. Код: [invalid_recaptcha] ',
